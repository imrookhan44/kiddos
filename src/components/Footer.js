          ...
          <div className="col-lg-3 col-md-3 col-sm-12 col-xs-12"> <div>
            ...
            <div className="questions">
              <div className='question-location'>
                <svg xmlns="http://www.w3.org/2000/svg" color='white' width="30" height="30" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
            ...
            <div className="questions">
              <div className='question-location'>
                <svg xmlns="http://www.w3.org/2000/svg" color='white' width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
            ...
            <div className="questions">
              <div className='question-location'>
                <svg xmlns="http://www.w3.org/2000/svg" color='white' width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
